...
if __name__ == "__main__":
    ...
    print("Path(__file__).resolve()",Path(__file__).resolve().parent.parent.parent)
    print("print(OUTPUT_DIR)",Path("output").resolve())
    print("os.path.abspath",os.path.abspath("models/audio-separator"))