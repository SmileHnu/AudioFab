...
2. Set up the virtual environment and Install dependencies，Alternatively, you can choose to follow a more comprehensive dependency relationship：`environment-lock.yml`
